...
export default function EditorialImagePanel() {
  ...
  const imageScale = useTransform(scrollY, [200, 1400], disable ? [1, 1] : [1.18, 1], { ease: easeOut });
  ...
  // On mobile: static render — no scroll hooks, no GPU cost
  if (isMobile) {
    return (
      <section className="relative w-full" style={{ zIndex: 15 }}>
        <div className="relative w-full overflow-hidden" style={{ boxShadow: '0 4px 20px rgba(86,43,42,0.08)' }}>
          <Image
          ...
          <div
            ...
            style={{ background: 'linear-gradient(to top, rgba(30,22,20,0.28) 0%, transparent 32%)' }}
            aria-hidden="true"
          />
          <p
            className="absolute top-6 right-8"
            style={{ fontSize: '10px', fontWeight: 500, letterSpacing: '0.18em', textTransform: 'uppercase', color: 'rgba(255,252,249,0.32)', margin: 0 }}
            aria-hidden="true"
          >
            01
          </p>
      ...
      <motion.div className="relative w-full" style={{ y: imageY }}>
        ...
        <motion.div className="relative w-full" style={{ y: settleY, zIndex: 1 }}>
          <div
            ...
            style={{
              borderRadius: '0',
              boxShadow: '0 8px 18px rgba(86,43,42,0.10), 0 24px 48px rgba(86,43,42,0.08), 0 60px 90px rgba(86,43,42,0.05)',
            }}
          >
            <motion.div
              style={{
